...
\author{Contini, Agust\'in - \textit{Padr\'on 89180}			\\
            ...
            Farina, Federico - \textit{Padr\'on 93376}			\\
            \texttt{ federicojosefarina@gmail.com }				\\
            Prystupiuk, Maximiliano  - \textit{Padr\'on 92333}			\\
...
\begin{abstract}
El trabajo práctico consiste en implementar el algoritmo de ordenamiento Quicksort y BubbleSort en lenguaje C, para luego comparar sus respectivas performance.
\end{abstract}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.9]{./recursos/graficoTiemposDeSortsMSeg.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.9]{./recursos/graficoComparacionLinuxMSeg.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.9]{./recursos/graficoComparacionLinuxMSegLogScale.png}
	\caption{Gr\'afico comparando los tiempos de los sorts corridos en Linux, con escala logar\'itmica}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.9]{./recursos/graficoComparacionGxemulMSeg.png}
...
\begin{center}
	\scalebox{1.8}{ $ SpeedUp = \frac {T_{bubblesort}} {T_{?????????}} $ }
\end{center}
\smallskip
\begin{center}
	\scalebox{1.8}{ $ SpeedUp = \frac {T_{????????? en C}} {T_{????????? en assembler}} $ }
\end{center}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.9]{./recursos/graficoSpeedups.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.9]{./recursos/graficoBBvsSSC.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.9]{./recursos/graficoSSAvsSSC.png}
